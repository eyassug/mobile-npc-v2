...
namespace MobileNPC.Core.Services
{
    ...
    public static class GS1Net
    {
        ...
        {
            get { return GS1Net.hasCheckSum; }
            set { GS1Net.hasCheckSum = value; }
        }

        public static char GroupSeparator
        {
            get { return GS1Net.groupSeparator; }
            set { GS1Net.groupSeparator = value; }
        }

        public static string EAN128StartCode
        {
            get { return GS1Net.ean128StartCode; }
            set { GS1Net.ean128StartCode = value; }
        }
